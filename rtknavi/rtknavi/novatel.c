...
#else
#define ID_BDSEPHEMERIS 1583    /* message id: oem6 decoded bds ephemeris */
#endif // !UNICORECONMM
                            ...
                            int *plock, int *clock, int *parity, int *halfc)
{
    ...
    *halfc =(stat>>28)&1;
    ...
    if (*sys==SYS_GPS||*sys==SYS_QZS) {
		...
		case  6: freq=2; *code=CODE_L6I; break;
		case  2: freq=2; *code=CODE_L6I; break;
		default: freq=-1; break;
		}
	}
#else
		...
		switch(sigtype){
		case  0: freq=0; *code=CODE_L1I; break;
		case 17: freq=1; *code=CODE_L7I; break;
		case 21: freq=2; *code=CODE_L6I; break;
		default: freq=-1; break;
		}
	}
