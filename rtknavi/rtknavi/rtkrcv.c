...
static int nmeacycle    =1000;          /* nmea request cycle (ms) */
...
static int startsvr(vt_t *vt)
{
	...
	//paths[0]="COM9:115200:8:n:1:off";
	//paths[1]="hc1:h1@222.187.25.170:9901/RTCM3:";
	//strtype[0]=STR_SERIAL;strtype[1]=STR_NTRIPCLI;
	//cmds[0]="log rangeb ontime 1\r\nlog rawephemb ontime 30\r\n";
	//strfmt[0]=STRFMT_OEM4;	strfmt[1]=STRFMT_RTCM3;
    /* start rtk server */
...
int main(int argc, char **argv)
{
    ...
    char *dev="",file[MAXSTR]="rtk.conf",cmd[3][MAXSTR];
    for (i=1;i<argc;i++) {
